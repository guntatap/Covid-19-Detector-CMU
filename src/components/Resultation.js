...
function Resultation() {
    ...
    const NavigateToIEnding = () => { navigate('/ending') }
    ...
    return (
        <div className='container' >
            ...
            <div className='Flex' style={{
                ...
                <button className='Button_Style' style={{ padding: '5px 14px', width: 'auto' }}> <h2 style={{ fontWeight: "normal" }} onClick={NavigateToIEnding}>
                    ออกจากหน้านี้ <br />
                </h2>
                </button>
            </div>
